...
const AirportInput = ({ 
  ...
  const searchAirports = async (query) => {
    setLoading(true)
    try {
      const response = await weatherService.searchAirports(query, 8)
      ...
      <div className="relative">
        <div className="relative">
          <input
            ...
            disabled={disabled}
            className={`w-full max-w-sm h-12 px-4 pr-20 text-base font-medium bg-white/80 border-2 rounded-xl placeholder-slate-400 focus:ring-2 focus:ring-blue-200/50 focus:border-blue-400 transition-all duration-200 shadow-sm hover:shadow-md backdrop-blur-sm ${
